const CACHE_NAME="japan-2026-v7";
const ASSETS=["./","./index.html","./style-final.css","./fixes.css","./script-final.js","./schedule-fix.js","./theme-sync.js","./fixes.js","./places.js","./planning_places.js","./planning_places_more.js","./data.json","./manifest.json","./icon.png"];
