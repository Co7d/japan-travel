...
const JAPAN_LEXICON = [
  ...
  ['Communication','Parlez-vous anglais ?','英語を話せますか？'],['Communication','Je ne parle pas japonais','日本語が話せません'],['Communication','Pouvez-vous répéter ?','もう一度お願いします'],['Communication','Pouvez-vous parler plus lentement ?','ゆっくり話してください'],['Communication','C’est combien ?','いくらですか？'],['Communication','Où est… ?','…はどこですか？'],['Communication','Je voudrais ceci','これをください'],['Communication','Pouvez-vous m’aider ?','手伝ってもらえますか？'],
  ['Restaurant','Menu','メニュー'],['Restaurant','Eau','お水'],['Restaurant','Eau chaude','お湯'],['Restaurant','Bière','ビール'],['Restaurant','Thé vert','お茶'],['Restaurant','Sans viande','肉なし'],['Restaurant','Sans poisson','魚なし'],['Restaurant','Je suis allergique à…','…にアレルギーがあります'],['Restaurant','L’addition, s’il vous plaît','お会計お願いします'],['Restaurant','Délicieux','おいしいです'],['Restaurant','À emporter','持ち帰り'],['Restaurant','Sur place','店内'],
  ['Shopping','Combien ça coûte ?','いくらですか？'],['Shopping','Je regarde seulement','見ているだけです'],['Shopping','Avez-vous une autre taille ?','別のサイズはありますか？'],['Shopping','Sac, s’il vous plaît','袋をお願いします'],['Shopping','Pas de sac, merci','袋はいりません'],
  ['Transport','Gare','駅'],['Transport','Train','電車'],['Transport','Métro','地下鉄'],['Transport','Bus','バス'],['Transport','Taxi','タクシー'],['Transport','Billet','切符'],['Transport','Quai','ホーム'],['Transport','Correspondance','乗り換え'],['Transport','Entrée','入口'],['Transport','Sortie','出口'],['Transport','Nord','北'],['Transport','Sud','南'],['Transport','Est','東'],['Transport','Ouest','西'],
  ['Hébergement','Hôtel','ホテル'],['Hébergement','Réservation','予約'],['Hébergement','Check-in','チェックイン'],['Hébergement','Check-out','チェックアウト'],['Hébergement','Bagages','荷物'],['Hébergement','Consigne à bagages','荷物預かり'],
  ['Pratique','Toilettes','トイレ'],['Pratique','Ouvert','営業中'],['Pratique','Fermé','閉店'],['Pratique','Aujourd’hui','今日'],['Pratique','Demain','明日'],['Pratique','Maintenant','今'],
